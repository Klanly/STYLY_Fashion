    ...
    public class OnLoad
    {
        ...
        private static void SetDefaultScriptEditor()
        {
            ...
            try
            {
                ...
                //
                // NOTE: We cannot clear solution here because Unity Editor will execute
                // this twice in some verisons and make Omnisharp cannot find solution 
                // files.
                //
        ...
        private static void PlayModeStateChanged()
        {
            if (EditorApplication.isPlayingOrWillChangePlaymode)
            {
                ...
                {
                    MainWindow.LastActiveInstance.CommunicateServices.SaveAll();
                }
        ...
        private static string GetStdioBridgePath()
        {
            ...
            var srcPath = Path.Combine(Application.dataPath, "uCodeEditor/Editor/Data/sb.db");
